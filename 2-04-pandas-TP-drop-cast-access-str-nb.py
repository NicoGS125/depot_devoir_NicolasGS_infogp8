...
# votre code
df.info()
# la colonne size est complètement vide
...
# votre code
print(df.dtypes)
# la colonne des masses n'est pas de type float comme on pourrait s'y attendre"
...
# %%
# votre code
valeurs_uniques = df['Mass (lb)'].unique()
print(valeurs_uniques)
# Certaines masses ne sont pas connues précisement, on a un encadrement
...
print(type(df['Mass (lb)']))
print(df[['Mass (lb) orig', 'Mass (lb)']].head())
